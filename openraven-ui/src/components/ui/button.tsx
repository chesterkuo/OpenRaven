...
const buttonVariants = cva(
  "inline-flex items-center justify-center text-base font-normal cursor-pointer transition-colors disabled:pointer-events-none disabled:opacity-50 disabled:cursor-default",
  {
    variants: {
      variant: {
